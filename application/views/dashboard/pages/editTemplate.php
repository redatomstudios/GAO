	...
	<div id="bodyWrap">
		<div id="pageContent">
			...
			<?php if(0) { ?>
				...
				<table style="font-size: 0.7em" class="centered">
					<tbody>
						<tr>
							<td>
						    <form id="fileupload2" class="fileupload" method="POST" enctype="multipart/form-data">
				...
				<table style="font-size: 0.7em" class="centered">
					<tbody>
						<tr>
							<td>
						    <form id="fileupload3" class="fileupload" method="POST" enctype="multipart/form-data">
						        <!-- Redirect browsers with JavaScript disabled to the origin page -->
						        <noscript><input type="hidden" name="redirect" value="http://blueimp.github.com/jQuery-File-Upload/"></noscript>
						        <!-- The fileupload-buttonbar contains buttons to add/delete files and start/cancel the upload -->
						        <div class="row fileupload-buttonbar">
			...
			<p>
				<button type="button" onclick="javascript: document.forms[0].submit();">Save Template</button> <button type="button" id="addField">Add Field</button>
			</p>
		</div>
